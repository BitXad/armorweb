    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Persona Edit</h3>
            </div>
			<?php echo form_open('persona/edit/'.$persona['persona_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="persona_nombre" value="<?php echo ($this->input->post('persona_nombre') ? $this->input->post('persona_nombre') : $persona['persona_nombre']); ?>" class="form-control" id="persona_nombre" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="persona_apellido" class="control-label">Persona Apellido</label>
						<div class="form-group">
							<input type="text" name="persona_apellido" value="<?php echo ($this->input->post('persona_apellido') ? $this->input->post('persona_apellido') : $persona['persona_apellido']); ?>" class="form-control" id="persona_apellido" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="persona_ci" class="control-label">Persona Ci</label>
						<div class="form-group">
							<input type="text" name="persona_ci" value="<?php echo ($this->input->post('persona_ci') ? $this->input->post('persona_ci') : $persona['persona_ci']); ?>" class="form-control" id="persona_ci" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="persona_direccion" value="<?php echo ($this->input->post('persona_direccion') ? $this->input->post('persona_direccion') : $persona['persona_direccion']); ?>" class="form-control" id="persona_direccion" />
						</div>
					</div>
				</div>
			</div>
