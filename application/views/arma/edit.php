    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Arma Edit</h3>
            </div>
			<?php echo form_open('arma/edit/'.$arma['arma_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="arma_fechaingreso" value="<?php echo ($this->input->post('arma_fechaingreso') ? $this->input->post('arma_fechaingreso') : $arma['arma_fechaingreso']); ?>" class="has-datepicker form-control" id="arma_fechaingreso" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="arma_horaingreso" class="control-label">Arma Horaingreso</label>
						<div class="form-group">
							<input type="text" name="arma_horaingreso" value="<?php echo ($this->input->post('arma_horaingreso') ? $this->input->post('arma_horaingreso') : $arma['arma_horaingreso']); ?>" class="form-control" id="arma_horaingreso" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="arma_foto" value="<?php echo ($this->input->post('arma_foto') ? $this->input->post('arma_foto') : $arma['arma_foto']); ?>" class="form-control" id="arma_foto" />
						</div>
					</div>
				</div>
			</div>
