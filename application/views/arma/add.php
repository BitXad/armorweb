                    ...
                    <div class="row clearfix">
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <input type="text" name="arma_numorden" value="<?php echo $this->input->post('arma_numorden'); ?>" class="form-control" id="arma_numorden" autofocus autocomplete="off" required />
                            </div>
                        </div>
                        <div class="col-md-3">
