			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="registro_fechasalida" value="<?php echo ($this->input->post('registro_fechasalida') ? $this->input->post('registro_fechasalida') : $registro['registro_fechasalida']); ?>" class="has-datepicker form-control" id="registro_fechasalida" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="registro_horasalida" class="control-label">Registro Horasalida</label>
						<div class="form-group">
							<input type="text" name="registro_horasalida" value="<?php echo ($this->input->post('registro_horasalida') ? $this->input->post('registro_horasalida') : $registro['registro_horasalida']); ?>" class="form-control" id="registro_horasalida" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="registro_fechaingreso" class="control-label">Registro Fechaingreso</label>
						<div class="form-group">
							<input type="text" name="registro_fechaingreso" value="<?php echo ($this->input->post('registro_fechaingreso') ? $this->input->post('registro_fechaingreso') : $registro['registro_fechaingreso']); ?>" class="has-datepicker form-control" id="registro_fechaingreso" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="registro_horaingreso" class="control-label">Registro Horaingreso</label>
						<div class="form-group">
							<input type="text" name="registro_horaingreso" value="<?php echo ($this->input->post('registro_horaingreso') ? $this->input->post('registro_horaingreso') : $registro['registro_horaingreso']); ?>" class="form-control" id="registro_horaingreso" />
						</div>
					</div>
					<div class="col-md-6">
