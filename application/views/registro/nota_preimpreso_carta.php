...
<div style="height: 1.2cm;">
     <table id="mitabla" style="margin-bottom: 0px;">
        ...
        <tr style="padding-top: 0px">
            ...
            <td align="center" style="width: 1.3cm;font-size: 11px"><?php echo date( "d", strtotime($registro["registro_fechasalida"]) ); ?> </td>
            <td align="center" style="width: 1.3cm;font-size: 11px"><?php echo date( "m", strtotime($registro["registro_fechasalida"]) ); ?> </td>
            <td align="center" style="width: 1.3cm;font-size: 11px"><?php echo date( "Y", strtotime($registro["registro_fechasalida"]) ); ?> </td>
...
<div style="height: 2cm;">
    <table id="mitabla" style="margin-bottom: 0px;">
        ...
        <tr style="padding-top: 0px">
            ...
            <td align="center" style="width: 1.3cm;font-size: 11px">00<?php echo  $registro["registro_id"]; ?> </td>
        </tr>
    </table>
    </div>
    <div style="height: 1.5cm;">
        ...
        <table   id="mitabla" style="margin-bottom: 0px">
            <tr>
                ...
                <td style="width: 12.3cm;font-size: 11px"><?php echo $registro["persona_apellido"];?> <?= $registro['persona_nombre'] ?> </td>
                <td style="width: 2.5cm;"></td>
                <td style="width: 2.5cm;font-size: 11px"><?php echo $registro["persona_telefono"]; ?> - <?php echo $registro["persona_celular"]; ?> </td>
            </tr>
    </table>
    </div>
    </div>
