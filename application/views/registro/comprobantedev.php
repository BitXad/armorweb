                ...
                <tr style="padding: 0;">
                    <td colspan="5" style="padding: 0;">
                        ...
                        <table style="font-family: Arial; font-size: 10px; width: <?php echo $ancho;?>cm;" id="mitabla" > 
                            ...
                            <tr>
                                <td style="width: 2cm;"></td>
                                <td style="width: 5cm; text-align: right; background-color: #aaa !important; -webkit-print-color-adjust: exact;" nowrap><b>SE RECIBIO DE: </b></td><td ></td><td style="width: 10cm; background-color: #ddd !important; -webkit-print-color-adjust: exact;"> <?php echo strtoupper($registro[0]['grado_descripcion']." ".$registro[0]['persona_apellido']." ".$registro[0]['persona_nombre']); ?></td>
                                <td style="width: 2cm;"></td>
                            </tr>
