...
<head>
    ...
    <meta name="keywords" content="registro, asignación" />
...
<?php } ?>
    ...
    <div class="login-page" style="background-image: url(<?php echo base_url("resources/images/camuflage.png"); ?>); background-repeat: no-repeat;background-size: cover; ">
